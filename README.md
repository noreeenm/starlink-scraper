...
└── static/                 # Placeholder for future CSS/JS assets
```
...
3. **Log in manually** using the following credentials:
   - **Username:** fundamentalssystem@gmail.com
   - **Password:** systemfundamentals2026
4. Solve any CAPTCHAs if prompted
5. Once logged in, the scraper takes over automatically:
...
6. When finished, the table populates in the UI and your **Total Data Usage** is displayed
7. Click **DOWNLOAD CSV REPORT** to save `starlink_usage.csv`
